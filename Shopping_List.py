...
2.Display single item details
3.Mark as  purchased
4.list all items in cart
5 .list items purchased
6.list item to be purchase
...
while True:
    ...
    match choice:
        case 1:
            ...
            print("Add price of the item")
            price = int(input(f"Enter the price of the item {item}: "))
            cart = {"id":iid,"item":item,"price":price,"is_purchased":False}
            carts.append(cart)
        case 2:
